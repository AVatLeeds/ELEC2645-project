...
struct DAC_registers
{
    ...
    uint32_t software_trigger_reg;
    uint32_t CH1_data_reg_12bit_right_allign;
    uint32_t CH1_data_reg_12bit_left_align;
    uint32_t CH1_data_reg_8bit;
    uint32_t CH2_data_reg_12bit_right_allign;
    uint32_t CH2_data_reg_12bit_left_align;
    uint32_t CH2_data_reg_8bit;
    uint32_t dual_data_reg_12bit_right_align;
    uint32_t dual_data_reg_12bit_left_align;
    uint32_t dual_data_reg_8bit;
    uint32_t CH1_present_output_reg;
    uint32_t CH2_present_output_reg;
    uint32_t status_Reg;
    uint32_t calibration_control_reg;
    uint32_t mode_control_reg;
    uint32_t CH1_sample_timer_reg;
    uint32_t CH2_sample_timer_reg;
    uint32_t sample_and_hold_reg;
    uint32_t sample_and_hold_refresh_time_reg;
};
...
class DAC_driver
{
    ...
    struct DAC_registers * registers;
